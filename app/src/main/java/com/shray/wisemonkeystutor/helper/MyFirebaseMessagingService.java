package com.shray.wisemonkeystutor.helper;
...
import com.shray.wisemonkeystutor.ui.TutorInterfaceActivity;
...
public class MyFirebaseMessagingService extends FirebaseMessagingService {
    ...
    private void showNotification(String message) {
        Intent intent=new Intent(this, TutorInterfaceActivity.class);
